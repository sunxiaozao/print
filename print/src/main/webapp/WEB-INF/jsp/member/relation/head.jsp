                ...
                <div class="container-fluid">
                    ...
                    <div id="menu">
                      <ul class="nav top-menu">
                      	...
                      	<li class="btnav-info selected"><a href="${SITE.context}/member/relation/list">我的好友</a></li>
                      	<li class="btnav-info"><a href="${SITE.context}/member/share/list">我的分享</a></li>
                      	<li class="btnav-info"><a href="${SITE.context}/member/info">个人中心</a></li>
                      </ul>
                    </div>    
                      ...
                      <ul class="nav pull-right top-menu">
                          ...
                          <li class="btnav-menu dropdown">
                               ...
                               <ul class="dropdown-menu">
                                  ...
                                  <li><a data-title="退出系统" href="${SITE.context}/member/logout"><i class="icon-off"></i> 退出系统</a></li>
                              </ul>
                          </li>
                      </ul>
                  </div><!--//b-top-nav:end-->
