...
<body id="login-page">
					...
					<div class="blb-form">
						<div class="row-fluid">
							...
							<div class="span12">
								...
								<form id="loginRemoteForm" action="" method="post" class="form-horizontal">
									
									<input type="hidden" value="${caseHistoryId }" id="caseHistoryId" name="caseHistoryId"/>
									<input type="hidden" value="${pass }" id="pass" name="pass"/>
									<input type="hidden" value="${shareId }" id="shareId" name="shareId"/>

									<div class="row-fluid">
										<div class="span4">
											<div class="control-group">
												<label class="control-label"> 查看密码： </label>
												<div class="controls">
													<input
														class="input validate[required,minSize[6],maxSize[6]]"
										...
										<div class="span8">
											<div class="control-group">
												<div class="controls">
													<button id="remoteButton" type="button"
	...
	<script>
		$(function() {
			...
			module.backpass.remoteDoctorInit();
