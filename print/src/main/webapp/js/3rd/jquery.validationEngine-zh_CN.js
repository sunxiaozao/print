	...
	$.validationEngineLanguage = {
		newLang : function() {
			$.validationEngineLanguage.allRules = {
				...
				"ajaxIc" : {
					"url" : "admin/doctor/checkuseronly/I",
					// you may want to pass extra data on the ajax call
					"extraData" : "name=eric",
					// if you provide an "alertTextOk", it will show as a green
					// prompt when the field validates
					"alertTextOk" : "* 此IC/ID可以使用",
					"alertText" : "* 此IC/ID已被其他人使用",
					"alertTextLoad" : "* 正在确认IC/ID是否有其他人使用，请稍等。"
				},
				"ajaxEmail" : {
					"url" : "admin/doctor/checkuseronly/E",
					// you may want to pass extra data on the ajax call
					"extraData" : "name=eric",
					// if you provide an "alertTextOk", it will show as a green
					// prompt when the field validates
				...
				"ajaxMobile" : {
					"url" :  "admin/doctor/checkuseronly/M",
					// you may want to pass extra data on the ajax call
					"extraData" : "name=eric",
					// if you provide an "alertTextOk", it will show as a green
					// prompt when the field validates
				...
				"manyEmail" : {//A plurality of mailbox verification
