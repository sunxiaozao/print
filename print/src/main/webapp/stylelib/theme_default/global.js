$(document).ready(function() {
    ...
    $("html, .js-scrooll").niceScroll({styler:"fb",cursorcolor:"#3399FF", cursorwidth: '10', cursorborderradius: '0', background: '#f0f0f0', cursorborder: '', zindex: '1031'});
...
var IframeModalCC = function(sMname,sAction) {
